...
psql -U postgres db_ucv_fhe_sist -f ./013_form_data_sequence.sql
psql -U postgres db_ucv_fhe_sist -f ./014_form_data_tables.sql
psql -U postgres db_ucv_fhe_sist -f ./015_form_data_functions.sql
psql -U postgres db_ucv_fhe_sist -f ./016_form_data_tables_datas.sql
psql -U postgres db_ucv_fhe_sist -f ./017_user_data_sequence.sql
psql -U postgres db_ucv_fhe_sist -f ./018_user_data_tables.sql
psql -U postgres db_ucv_fhe_sist -f ./019_user_data_functions.sql
psql -U postgres db_ucv_fhe_sist -f ./020_user_data_tables_datas.sql
