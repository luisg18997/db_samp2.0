...
COPY 009_form_data_sequence.sql /docker-entrypoint-initdb.d/
COPY 010_form_data_tables.sql /docker-entrypoint-initdb.d/
COPY 011_form_data_functions.sql /docker-entrypoint-initdb.d/
COPY 012_form_data_tables_datas.sql /docker-entrypoint-initdb.d/
...
COPY 017_process_form_sequence.sql /docker-entrypoint-initdb.d/
COPY 018_process_form_tables.sql /docker-entrypoint-initdb.d/
COPY 019_process_form_functions.sql /docker-entrypoint-initdb.d/
COPY 020_process_form_tables_datas.sql /docker-entrypoint-initdb.d/
