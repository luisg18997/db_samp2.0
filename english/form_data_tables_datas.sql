...
-- data of table annex_types_for_movement_types_history
SELECT form_data.annex_types_for_movement_type_insert(1, 1, 0);
SELECT form_data.annex_types_for_movement_type_insert(2, 1, 0);
SELECT form_data.annex_types_for_movement_type_insert(3, 1, 0);
SELECT form_data.annex_types_for_movement_type_insert(4, 1, 0);
SELECT form_data.annex_types_for_movement_type_insert(5, 1, 0);
SELECT form_data.annex_types_for_movement_type_insert(6, 1, 0);
SELECT form_data.annex_types_for_movement_type_insert(7, 1, 0);
SELECT form_data.annex_types_for_movement_type_insert(4, 2, 0);
SELECT form_data.annex_types_for_movement_type_insert(8, 2, 0);
SELECT form_data.annex_types_for_movement_type_insert(1, 3, 0);
SELECT form_data.annex_types_for_movement_type_insert(4, 3, 0);
SELECT form_data.annex_types_for_movement_type_insert(5, 3, 0);
SELECT form_data.annex_types_for_movement_type_insert(6, 3, 0);
SELECT form_data.annex_types_for_movement_type_insert(9, 3, 0);
SELECT form_data.annex_types_for_movement_type_insert(4, 13, 0);
SELECT form_data.annex_types_for_movement_type_insert(10, 13, 0);
SELECT form_data.annex_types_for_movement_type_insert(4, 14, 0);
