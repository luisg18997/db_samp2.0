CREATE TABLE process_form.process_form_movement_personal(
	...
	CONSTRAINT form_mov_per_unique UNIQUE (form_movement_personal_id)
);

CREATE TABLE process_form.process_form_ofice(
	...
	last_modified_by BIGINT NOT NULL,
	last_modified_date TIMESTAMP WITHOUT TIME ZONE NOT NULL,
	CONSTRAINT form_office_unique UNIQUE (form_ofice_id)
);
...
-- tb history
CREATE TABLE process_form.process_form_movement_personal_history(
...
CREATE TABLE process_form.process_form_ofice_history(
...
-- ADD PK in the tables
	ALTER TABLE only process_form.process_form_movement_personal
		ADD CONSTRAINT process_form_movement_personal_id PRIMARY KEY (id);

	ALTER TABLE only process_form.process_form_ofice
